...
void galeria:: opciones_galeria(){
    ...
    case 0:
        ...
        ui->min1_boton->setStyleSheet("background-color: rgba(191, 64, 64, 0);\nbackground-repeat:none;\nborder:none;\n\n");
        break;
    case 1:
        ui->min1_boton->setStyleSheet("background-color:red;");
        ui->comboBox->setStyleSheet("background-color: rgba(191, 64, 64, 0);\nbackground-repeat:none;\nborder:none;\n\n");
        ui->min2_boton->setStyleSheet("background-color: rgba(191, 64, 64, 0);\nbackground-repeat:none;\nborder:none;\n\n");
        break;
    case 2:
        ui->min2_boton->setStyleSheet("background-color:red;");
        ui->min1_boton->setStyleSheet("background-color: rgba(191, 64, 64, 0);\nbackground-repeat:none;\nborder:none;\n\n");
        ui->min3_boton->setStyleSheet("background-color: rgba(191, 64, 64, 0);\nbackground-repeat:none;\nborder:none;\n\n");
        break;
    case 3:
        ui->min3_boton->setStyleSheet("background-color:red;");
        ui->min2_boton->setStyleSheet("background-color: rgba(191, 64, 64, 0);\nbackground-repeat:none;\nborder:none;\n\n");
        ui->trash->setStyleSheet("border: 0px;");
        ui->trash->setIcon(QIcon(":/imagenes/btn_Eliminar.png"));
        break;
    case 4:
        ui->trash->setStyleSheet("background-color:red;");
        ui->min3_boton->setStyleSheet("background-color: rgba(191, 64, 64, 0);\nbackground-repeat:none;\nborder:none;\n\n");
        ui->toolButton->setStyleSheet("border: 0px;");
